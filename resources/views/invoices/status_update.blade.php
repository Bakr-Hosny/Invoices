                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_number"
                                  value="{{ $invoice->invoice_number }}"  title="يرجي ادخال رقم الفاتورة" required readonly>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="Section" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    onchange="console.log('change is firing')" required readonly>
                                    <!--placeholder-->
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="Amount_collection"
                                    ...
                                    value="{{ $invoice->amount_collction}}" readonly>
                            </div>
                        </div>
