...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('invoices_update') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="hidden" class="form-control" id="inputName" name="old_invoice_number"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="Section" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                    <option value="{{ $invoice->section->id }}" selected disabled>{{ $invoice->section->section_name }}</option>
                            ...
                            <div class="col">
                                ...
                                <select id="product" name="product" class="form-control">
                                    <option value="{{ $invoice->product}}" selected disabled>{{ $invoice->product }}</option>
                                </select>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="Amount_collection"
                                    ...
                                    value="{{ $invoice->amount_collction}}">
                            </div>
                        </div>
